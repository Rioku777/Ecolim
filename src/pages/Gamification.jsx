    ...
    import { Puzzle, BrainCircuit, Zap, Leaf, CheckCircle, XCircle, MousePointerClick, Award, Gamepad2 } from 'lucide-react';
    ...
    const EcoClickerGame = ({ onGameEnd }) => {
        ...
        }, [timeLeft, gameStarted, clicks, onGameEnd, toast]);
    ...
    const initialGameData = [
        ...
        { id: 2, title: 'EcoClicker', icon: <MousePointerClick className="h-8 w-8 md:h-10 md:w-10 text-teal-500" />, description: '¡Haz click rápido para ganar puntos!', status: 'Disponible', pointsAwarded: 0 },
